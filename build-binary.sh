...
LOCAL_DF_AI_DIR="${LOCAL_DF_AI_DIR:-$SCRIPT_DIR/../df-development/packages/df-ai}"
LOCAL_DF_AI_CHAT_DIR="${LOCAL_DF_AI_CHAT_DIR:-$SCRIPT_DIR/../df-development/packages/df-ai-chat}"
